...
public class EmailMessages {
    ...
    private static String ONBOARDING_DOCUMENT_EMAIL_TEXT = "Dear %s,\n" +
            ...
            "%s" +
            "\u2028\u2028Please review these materials at your convenience and feel free to reach out if you have any questions or if there’s anything you’d like to discuss further.\u2028\u2028Best,\u2028 %s";
